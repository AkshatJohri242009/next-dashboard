...
export default function CorrelationsPage() {
  return (
    <div className="space-y-6 relative">
      <div className="fixed top-1/3 left-[-100px] w-[400px] h-[400px] rounded-full bg-gradient-to-br from-warning/10 to-accent/5 blur-[100px] opacity-20 pointer-events-none " />
