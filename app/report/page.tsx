...
export default function ReportPage() {
  return (
    <div className="space-y-6 relative">
      <div className="fixed top-1/3 left-[-250px] w-[600px] h-[600px] rounded-full bg-gradient-to-br from-success/10 to-brand/5 blur-[120px] opacity-20 pointer-events-none animate-breathing" />
